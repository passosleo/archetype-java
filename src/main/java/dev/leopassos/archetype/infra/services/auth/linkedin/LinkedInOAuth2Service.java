package dev.leopassos.archetype.infra.services.auth.linkedin;
...
@Qualifier("linkedin")
@Service
public class LinkedInOAuth2Service implements IOAuth2Service {

    private final IOAuth2Client authClient;
    private final IUserRepository userRepository;

    public LinkedInOAuth2Service(@Qualifier("linkedin") IOAuth2Client authClient, IUserRepository userRepository) {
