...
@Service
public class LoginFacebookUseCase implements ILoginFacebookUseCase {
    ...
    public LoginFacebookUseCase(@Qualifier("facebook") IOAuth2Service authService, ITokenService tokenService) {
